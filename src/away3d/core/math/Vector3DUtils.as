package away3d.core.math
{
	...
	public class Vector3DUtils
	{
		...
		public static function matrix2euler(m1:Matrix3D):Vector3D
		{
			...
			var cy:Number = Math.sqrt(raw[0]*raw[0] + raw[1]*raw[1]); // T cy = Math<T>::sqrt (N[0][0]*N[0][0] + N[0][1]*N[0][1]);
		...
		[Inline]
		static public function distance(v1:Vector3D, v2:Vector3D):Number 
		{
			var xx:Number = (v1.x - v2.x);
			xx *= xx;
			
			var yy:Number = (v1.y - v2.y);
			yy *= yy;
			
			var zz:Number = (v1.z - v2.z);
			zz *= zz;
