package away3d.core.pick
{
	...
	public class PickingType
	{
		...
		/**
		 * Uses AS3 to pick objects based on ray intersection. Returns the hit on the first encountered Entity.
		 */
		public static const RAYCAST_FIRST_ENCOUNTERED:IPicker = new RaycastPicker(false);
		
		/**
		 * Uses AS3 to pick objects based on ray intersection. Returns the best (closest) hit on an Entity.
		 */
